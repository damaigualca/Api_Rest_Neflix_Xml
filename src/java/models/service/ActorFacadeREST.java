 ...
 */
@Stateless
@Path("servicios.actor")
public class ActorFacadeREST extends AbstractFacade<Actor> {

    @PersistenceContext(unitName = "RESTNeflixPU")
    private EntityManager em;

    public ActorFacadeREST() {
        super(Actor.class);
        this.em=Persistence.createEntityManagerFactory("RESTNeflixPU").createEntityManager();
    }
